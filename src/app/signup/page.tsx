...
export default function SignupPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-500">
      <form
      ...
      >
        ...
        <input
          ...
          value={form.name}
          className="border p-2 mb-2 w-full rounded focus:ring-2 focus:ring-blue-400 focus:ring-offset-1 outline-none dark:bg-gray-800 dark:text-white dark:border-gray-700 transition-colors duration-300"
        ...
        <input
          ...
          value={form.password}
          className="border p-2 mb-4 w-full rounded focus:ring-2 focus:ring-blue-400 focus:ring-offset-1 outline-none dark:bg-gray-800 dark:text-white dark:border-gray-700 transition-colors duration-300"
