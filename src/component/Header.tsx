    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          ...
          <ul className="hidden md:flex items-center gap-4 text-lg font-medium">
            <li>
              <Link className="btn btn-ghost btn-sm hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-white" href="/home">
                Dashboard
              </Link>
            </li>
            <li>
              <Link className="btn btn-ghost btn-sm hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-white" href="/signup">
                Signup
              </Link>
            </li>
            <li>
              <Link className="btn btn-ghost btn-sm hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-white" href="/login">
                Login
              </Link>
            </li>
          </ul>
      ...
      >
        ...
        <ul className="flex flex-col p-4 gap-3">
          <li>
            <Link className="btn btn-ghost w-full justify-start hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-white" href="/home" onClick={() => setSidebarOpen(false)}>
              Dashboard
            </Link>
          </li>
          <li>
            <Link className="btn btn-ghost w-full justify-start hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-white" href="/signup" onClick={() => setSidebarOpen(false)}>
              Signup
            </Link>
          </li>
          <li>
            <Link className="btn btn-ghost w-full justify-start hover:bg-gray-100 hover:text-gray-900 dark:hover:bg-gray-800 dark:hover:text-white" href="/login" onClick={() => setSidebarOpen(false)}>
              Login
            </Link>
          </li>
          <li>
